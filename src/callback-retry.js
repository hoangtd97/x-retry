 ...
 * @param {any[]} [options.args=[]] arguments of function
 ...
 * @param {number|function} [options.timeout=200] delay between retry operation, , default is generated by Timeout.
 * if is function, must match interface : (retry_count, maxRetry, logs) => number
 * @param {string} [options.activity] what is this activity name ? default is func.name
 ...
 */
function callbackRetry({ func, thisArg, args = [], callback, isRetry, maxRetry = 3, retry_count = 0, timeout = genTimeout, logs = [], actor, activity }) {
