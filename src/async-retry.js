 ...
 * @param {number|function} [options.timeout] delay between retry operation, default is generated by Timeout.
 ...
 */
async function asyncRetry({ func, thisArg, args = [], isRetry, maxRetry = 3, timeout = genTimeout, actor, activity }) {
